...
var (
	...
	ErrOutcomeAlreadyApplied = errors.New("outcome already applied")
	// ErrOutcomeCharacterNotFound indicates a character state is missing.
	ErrOutcomeCharacterNotFound = errors.New("character state not found")
	// ErrOutcomeGMFearInvalid indicates a GM fear mutation is invalid.
	ErrOutcomeGMFearInvalid = errors.New("gm fear update invalid")
)
...
// OutcomeApplyRequestedPayload captures the event payload for outcome apply requests.
type OutcomeApplyRequestedPayload struct {
