...
scene:gm_spend_fear(1):spotlight("Ranger of the North")
scene:apply_condition{ target = "Frodo", add = { "VULNERABLE" }, source = "snowblind_trap" }
scene:apply_condition{ target = "Sam", add = { "VULNERABLE" }, source = "snowblind_trap" }
