...
scene:action_roll{ actor = "Frodo", trait = "agility", difficulty = 5, outcome = "hope" }

-- Example: Finesse difficulty 15 to ride through rough terrain.
scene:action_roll{ actor = "Frodo", trait = "finesse", difficulty = 15, outcome = "hope" }

-- Example: Strength difficulty 25 to lift a large beast.
scene:action_roll{ actor = "Frodo", trait = "strength", difficulty = 25, outcome = "fear" }
